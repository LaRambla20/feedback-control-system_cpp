...
* Finally from the `visualisation` folder run the script to compare the signals obtained from the reference simulink model and the ones obtained instead from the C++ scripts: in other words, this will plot both `scope_data.tsv` and `scope_data_mod.tsv`
	<p align="center">
		<img src="https://github.com/LaRambla20/feedback-control-system_cpp/assets/91536387/defdcfa5-6fa8-49ad-ab9a-f4beaa401633" width="450" />
		<img src="https://github.com/LaRambla20/feedback-control-system_cpp/assets/91536387/bcd04bdd-6f0e-4b36-b151-d131b4720729" width="450" />
	</p>
